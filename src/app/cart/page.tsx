      ...
      <div className="mt-12 grid gap-12 border-t border-black/20 pt-8 lg:grid-cols-[minmax(0,1fr)_minmax(18rem,0.34fr)] lg:gap-16">
        ...
        <aside className="h-fit border-t border-black pt-6 lg:sticky lg:top-24">
          ...
          {!hasUnavailableLines && subtotal !== null ? (
            <Link
              className="mt-7 block border border-black bg-black px-5 py-4 text-center text-sm font-semibold uppercase tracking-[0.14em] text-white hover:bg-transparent hover:text-black focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
              href="/checkout"
            >
              Tiến hành đặt hàng
            </Link>
