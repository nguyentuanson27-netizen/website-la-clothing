...
- [~] C8 Pancake create-order orchestration — contract-verification foundation in draft PR #43
  ...
  - [x] review-fix docs/tracker evidence synchronized; exact-head CI verification is recorded in the PR review handoff rather than self-referenced inside this tracker
