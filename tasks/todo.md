...
- [ ] T4 Add database and secure CUSTOMER/ADMIN auth foundation
- [ ] T5 Implement typed Pancake adapter with schema validation
- [ ] T6 Implement idempotent catalog synchronization/mirror
- [ ] T7 Deliver Pancake-backed PLP/PDP vertical slice
- [ ] T8 Deliver stock-aware Color × Size selection and anonymous cart
- [ ] T9 Deliver guest COD checkout → exactly one Pancake order
- [ ] T10 Sync order statuses and implement safe guest tracking
- [ ] T11 Add optional customer account and protected order history
