...
- [ ] **U33** #152 P5/W13 — evergreen pages only from human-approved facts; no invented policies. **B1–B4 and B6 are RESOLVED; U33 is partly implemented.** Build About/Returns/Shipping/Size/Contact and approved policy surfaces from one shared fact authority; founding story/values remain optional/open and must not be invented. Split into focused PRs so a policy page's review and revert boundary is its own. Substates below.
  ...
  - [ ] **U33b** W13 Returns + Shipping/Payment from B1 and B4 — 15-day window, the approved condition list, the 50,000 VND customer-initiated exchange fee with two-way shipping, shop/manufacturer fault covering reasonable shipping, 7–10 working-day refund; nationwide delivery, GHN/GHTK, 1–3 day inner-city and 3–15 day other-province **estimates** (not an SLA), no default carrier tracking, optional verification call. Server shipping config stays the pricing authority.
