...
- [x] Feed↔JSON-LD one-survivor parity implementation + verification green under the approved contract. **Closed by PR #214**; see `docs/audits/merchant-jsonld-parity.md`.
